package logia.assistant.gateway;

import logia.assistant.gateway.config.ApplicationProperties;
import logia.assistant.gateway.config.DefaultProfileUtil;
...
public class AssistantGatewayApp {
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AssistantGatewayApp.class);
